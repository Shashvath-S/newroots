    ...
    <>
        ...
        <div className="max-w-auto mx-auto">
          <section className="rounded-lg p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <article className="bg-white rounded-lg p-5 card-border shadow-sm">
                <div className="h-32 bg-gray-100 rounded-md flex items-center justify-center mb-4">
                  ...
                  >
                    <path
                      ...
                      d="M3 7v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7M7 3v4M17 3v4"
                    ></path>
                  </svg>
                </div>
      ...
      <footer className="mt-12 border-t bg-white">
        ...
        <div className="mt-8 text-center text-xs text-gray-400">
          © <span id="year"></span> NewRoots. All rights reserved.
        </div>
      </footer>
    </>
  );
